...
$(function () {
  ...
  *********************************/
  ...
  if ($(".particles-js.dots").length) {
    // Define options for a soft-glow particle effect
    const particleCount = 80;
    const particleColors = ["#FFD700", "#FF69B4", "#1E90FF"];
    const particleSize = {
      default: 10,
      min: 5,
      speed: 1
    ...
    const customParticlesOptions = {
      particles: {
        ...
        shape: {
          type: ["circle", "triangle"], // Mix of circles and triangles for variety
          stroke: { width: 0 }
        },
        opacity: {
          value: 0.3,
        ...
        size: {
          value: particleSize.default,
          random: true,
          anim: {
            enable: true,
            speed: particleSize.speed,
            size_min: particleSize.min,
            sync: false
          }
        },
        line_linked: {
        ...
        move: {
          enable: true,
          speed: moveSettings.speed,
          direction: "none",
          random: true,
          straight: false,
          out_mode: moveSettings.outMode,
          bounce: moveSettings.bounce,
      ...
      interactivity: {
        detect_on: "canvas",
        events: {
          onhover: { enable: interactivitySettings.hover, mode: "bubble" },
          onclick: { enable: interactivitySettings.click, mode: "push" },
          resize: interactivitySettings.resize
        },
        modes: {
          bubble: { distance: 150, size: 12, duration: 2, opacity: 0.4, speed: 1 }
        }
      },
      retina_detect: true
    };
