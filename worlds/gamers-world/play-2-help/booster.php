...
$performCB = array(
  0 => 'https://login.performcb.com/api/v5/performcb_api?get=offer_feed&api_key=2c2390c5a854fed1102f3b47b2178697&user_id=102620&offer_name=55',
  1 => 'https://login.performcb.com/api/v5/performcb_api?get=offer_feed&api_key=2c2390c5a854fed1102f3b47b2178697&user_id=102620&offer_name=44',
  2 => 'https://login.performcb.com/api/v5/performcb_api?get=offer_feed&api_key=2c2390c5a854fed1102f3b47b2178697&user_id=102620&offer_name=33'
);
...
file_put_contents("xml_file2.xml", file_get_contents($performCB[$randomIndex]));

$xml_data = simplexml_load_file("xml_file2.xml") or
  die("Error: Object Creation failure");


// var_dump($xml_data->offers->offer[2]);

$list = $xml_data->offers;

// var_dump($list[0]->offer[2]);

// for ($i = 0; $i < count($list); $i++) {
//   echo '<b>Man no:</b> ' . $list[0]->offer->offer_id[0] . '<br>';

//   echo 'Name: ' . $list[$i]->vertical_name . '<br>';

//   echo 'Position: ' . $list[$i]->preview_url . '<br><br>';
// }
...
<head>
  <meta charset="utf-8" />
  <title>Play2Help Fun Free Games Rewards Boost rewards page</title>
  ...
  <div class="container">
    <div class="swiper mySwiper" style="height: 200px;">
      <div class="swiper-wrapper">
        ...
        for ($i = 0; $i < count($list[0]->offer); $i++) {
          // echo '<b>Man no:</b> ' . $list[0]->offer->offer_id[0] . '<br>';

        ?>

          <div class="swiper-slide">
            <a href="<?php echo $list[0]->offer[$i]->preview_url[0] ?>" target="_blank">
              <img class="img-fluid" style="width: -webkit-fill-available;height: -webkit-fill-available;object-fit: cover;background-size: cover;background-position: center;" src="images/ad-placeholder.jpg" alt="Free Trial 2x.png">
            </a>
          </div>

        <?php } ?>
      </div>
      <div style="color: #000;" class="swiper-button-next"></div>
  ...
  <div class="container my-4">
    ...
    <div class="row">
      <div class="my-3 col-12 col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <img class="img-fluid" src="/images/Amazon Promos 4x.png" alt="Amazon Promo">
      </div>
      <div class="my-3 col-12 col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <img class="img-fluid" src="/images/Add Video 2x.png" alt="Add Video">
      </div>
      <div class="my-3 col-12 col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <img class="img-fluid" src="/images/Easy Surveys 2x.png" alt="Each surveys">
      </div>
      <div class="my-3 col-12 col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <img class="img-fluid" src="/images/Free Apps 2x.png" alt="Free Apps 2x.png">
      </div>
      <div class="my-3 col-12 col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <img class="img-fluid" src="/images/Free Trial 2x.png" alt="Free Trial 2x.png">
      </div>
      <div class="my-3 col-12 col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <img class="img-fluid" src="/images/Fun Stuff 2x.png" alt="Fun Stuff 2x.png">
      </div>
      <div class="my-3 col-12 col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <img class="img-fluid" src="/images/Social Post 2x.png" alt="Social Post 2x.png">
      </div>
      <div class="my-3 col-12 col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <img class="img-fluid" src="/images/Update Profile 2x.png" alt="Update Profile 2x.png">
      </div>
      <div class="my-3 col-12 col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <img class="img-fluid" src="/images/Fun Ads 2x.png" alt="Fun Ads 2x.png">
      </div>
    </div>
      ...
      if (localStorage.getItem("logged_in")) {
        ...
        $.ajax({
          ...
          data: {
            ...
            activity_name: "Booster Interactions",
            website: 'Play2Help'
          },
